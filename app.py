...
# --------------------------------------------------
# ⚙️ 사이드바: 1. API Key -> 2. 품목 선택 -> 3. 세부 모델 선택 -> 4. HOME 버튼 (순서 완벽 고정)
# --------------------------------------------------
with st.sidebar:
    st.header("시스템 설정")
    ...
    # 💡 3. 세부 모델 선택 (품목 선택 바로 아래에 오도록 변경)
    ...
    # 💡 4. HOME 버튼은 항상 무조건 사이드바 맨 하단에 위치!
    st.markdown("---")
